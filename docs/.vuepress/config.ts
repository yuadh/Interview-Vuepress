...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "yuadhのinterview_note",
      description: 'yuadh的面试笔记网站',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'yuadh/interview2', // 导航栏右侧生成Github链接
    ...
    updateBar: { // 最近更新栏
      ...
      moreArticle: '/code' // “更多文章”跳转的页面，默认'/archives'
    },
    ...
    author: {
      name: 'yuadh', // 必需
      link: 'https://github.com/yuadh', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'yuadh | <a href="https://github.com/yuadh/interview2/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
